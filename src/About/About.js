        ...
        <div className='preview-area'>
          ...
          <div className='preview-slider-area'>
            <div className='preview-slider'>
              ...
              <div className='slider-btn prev'><img className='slider-btn-img' onClick={handleClickPrvBtn} src='https://cdn-icons-png.flaticon.com/512/254/254442.png' alt='' /></div>
              <div className='slider-btn next'><img className='slider-btn-img' onClick={handleClickNextBtn} src='https://cdn-icons-png.flaticon.com/512/254/254442.png' alt='' /></div>
            </div>
          </div>
        </div>
        {
